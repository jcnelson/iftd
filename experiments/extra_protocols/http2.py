...
"""
class http2_sender( iftproto.iftsender ):
   def __init__(self):
   ...
   def proto_clean(self):
      ...
      for file in self.available_files:
         ...
         try:
            # TODO: what happens if multiple receivers are getting the file?
            self.http_server.available_files.remove( file )
         except:
            pass
...
"""
class http2_receiver( iftproto.iftreceiver ):
